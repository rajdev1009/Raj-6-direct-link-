...
.ct-btn.notify { background:#1a3a2a; color:#7ee787; }
.ct-btn.notify:disabled { opacity:.6; cursor:default; }
.ct-btn.tg { background:#0088cc; }
.ct-btn.ig { background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888); }
...
var ACCESS_ID = "%05d";
var IG_USER = %q;
var NOTIFY_URL = "/notify/" + encodeURIComponent(%q);
var currentLang = 'en';
var I18N = {
...
</body></html>`, accessID, html.EscapeString(prefillName), url.QueryEscape(tgUser), accessID, igUser, slug)
}
